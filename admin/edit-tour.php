...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Buttercups Tours - Edit  Tour Services</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title"> EDIT TOUR SERVICES</h4></center>
        </div>
        <div class="card-content">
          ...
          <?php
                include 'db.php';
                $id = $_GET['id'];
                $geto  = mysqli_query($conn,"SELECT * FROM tour WHERE  id = '$id' ");
                $row = mysqli_fetch_array($geto);
          ?>
            <form class="form form-horizontal" id="upttourfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Name of Tour Service</label>
                  </div>
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="title" placeholder="service name" value="<?php echo $row['title'];?>">
