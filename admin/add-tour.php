...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Buttercups Tours - Add Tour Service</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">TOUR SERVICE  FORM</h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="tourfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="title" placeholder="service name">
                  </div>
                  <!-- <div class="col-md-4">
                    <label>Email</label>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea   class="form-control" name="description" placeholder="List what included  NB separate with Comma's eg:(eating, dacing)"></textarea>
                  </div>
