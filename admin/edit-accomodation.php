...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Buttercups Tours - Edit Accomodation</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title"> EDIT Accomodation</h4></center>
        </div>
        <div class="card-content">
          ...
          <?php
                include 'db.php';
                $id = $_GET['id'];
                $geto  = mysqli_query($conn,"SELECT * FROM acomo WHERE  id = '$id' ");
                $row = mysqli_fetch_array($geto);
          ?>
            <form class="form form-horizontal" id="uptaccfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Name of Accomodation</label>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <div class="form-group" data-select2-id="116">
                        ...
                        <option value="<?php echo $row['ltype'];?>" data-select2-id="103"><?php echo $row['ltype'];?> </option>
