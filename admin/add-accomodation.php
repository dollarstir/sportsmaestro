...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Buttercups Tours - Add Accomodation</title>
    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">ACCOMODATION  FORM</h4></center>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form class="form form-horizontal" id="accfrm">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <label>Picture of Accomodation</label>
                  </div>
                  <div class="col-md-8 form-group">
