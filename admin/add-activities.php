    ...
    <div class="col-md-10 col-12">
      <div class="card">
        <div class="card-header">
          <center><h4 class="card-title">NEW PLAYER  FORM</h4></center>
        </div>
            ...
            <form class="form form-horizontal" id="actfrm">
              <div class="form-body">
                <div class="row">
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="jnumber" placeholder="jersey number">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="date" id="first-name" class="form-control" name="dob" placeholder="Date of birth">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="pob" placeholder="place of birth">
                  </div>


                  <div class="col-md-4">
                    <label>Team of play</label>
                  </div>
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="pfor" placeholder="Team of play">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="height" placeholder="height">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="weight" placeholder="weight">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="ecolor" placeholder="eye color">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="hcolor" placeholder="Hair Color">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="position" placeholder="Position">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="etc" placeholder="Ethnicity">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="defend" placeholder="Defend">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="speed" placeholder="Speed">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="possession" placeholder="Possession">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="throw" placeholder="Throw">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="passess" placeholder="Passess">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="dribble" placeholder="Dribble">
                  </div>

                  <div class="col-md-4">
                    <label>Goal Keeping</label>
                  </div>
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="keeping" placeholder="Goal keeping">
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <input type="text" id="first-name" class="form-control" name="attack" placeholder="Attack">
                  </div>

                  <div class="col-md-4">
                    <label>Video of Player</label>
                  </div>
                  <div class="col-md-8 form-group">
                  <div class="custom-file">
                        <input type="file" class="custom-file-input" id="vid" name="video">
                        <label class="custom-file-label" for="vid">Choose file</label>
                      </div>
                  </div>


                  <div class="col-md-4">
                    <label>Bio of Player</label>
                  </div>
                  <div class="col-md-8 form-group">
                  ...
                  <div class="col-md-4">
                    <label>Other Pictures of player</label>
                  </div>
                  <div class="col-md-8 form-group">
                  <div class="custom-file">
                        <input type="file" class="custom-file-input" id="ipt1" name="mpics[]" multiple>
                        <label class="custom-file-label" for="ipt1">Choose  multiple images</label>
                      </div>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="eyes"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="ears"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="brains"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="lungs"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="pulse"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="bp"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="heart"></textarea>
                  </div>
                  <div class="col-md-4">
                    <label>ECG</label>
                  </div>
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="ecg"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="limbs"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="tone"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="joints"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="abdomin"></textarea>
                  </div>
                  ...
                  <div class="col-md-8 form-group">
                    <textarea class="form-control" name="custome"></textarea>
                  </div>
