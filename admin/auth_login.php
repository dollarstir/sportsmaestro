...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Next Sports Maestro - Login</title>
...
<section id="auth-login" class="row flexbox-container">
    <div class="col-xl-8 col-11">
        <div class="card bg-authentication mb-0">
            <div class="row m-0" style="background-color:#ffff;">
                <!-- left section-login -->
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                    <div class="card-content" style="background-color:#ffff;">
                        <img class="img-fluid" src="../images/logbg.png" alt="branding logo" style="width:100%;height:100%">
                    </div>
                </div>
            </div>
        </div>
